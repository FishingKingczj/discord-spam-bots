...
userToken = ['fishingkingczj@qq.com:czj199842'] # User Tokens here. example 'token','token' | 'email:pass', 'token'
DiscordChannel = '' # Channel ID,
SpamSpeed = 1 # Changes how fast the messages are posted. (Anything under 0.7 tends to break it (┛✧Д✧))┛彡┻━┻ )
...
#Server Joiner
useTokenJoin = True
inviteLink = '6c5nDF' # Only the last 6 digits of the invite link https://discord.gg/XXXXXX | Unless you are using email join then just the full URL
